...
#define sem_tcp_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define sem_tcp_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define sem_tcp_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define sem_tcp_SLEEP_API_INIT     __SEM_API_INIT
#define sem_tcp_SLEEP_API_DESTROY  __SEM_API_DESTROY
#define sem_tcp_SLEEP_API_SLEEP    __SEM_API_SLEEP
#define sem_tcp_SLEEP_API_WAKEUP   __SEM_API_WAKEUP
