#ifndef _THC1_FIN_MUTLOCK_H_
#define _THC1_FIN_MUTLOCK_H_

#define NAME thc1

#define thc1_SPIN_API_INIT      __NOFIFO_SPIN_API_INIT
#define thc1_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define thc1_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define thc1_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define thc1_SLEEP_API_INIT     __FUTEX_API_INIT
#define thc1_SLEEP_API_DESTROY  __FUTEX_API_DESTROY
#define thc1_SLEEP_API_SLEEP    __FUTEX_API_SLEEP
#define thc1_SLEEP_API_WAKEUP   __FUTEX_API_WAKEUP
