#ifndef _THC12_FIN_MUTLOCK_H_
#define _THC12_FIN_MUTLOCK_H_

#define NAME thc12

#define thc12_SPIN_API_INIT      __NOFIFO_SPIN_API_INIT
#define thc12_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define thc12_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define thc12_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define thc12_SLEEP_API_INIT     __FUTEX_API_INIT
#define thc12_SLEEP_API_DESTROY  __FUTEX_API_DESTROY
#define thc12_SLEEP_API_SLEEP    __FUTEX_API_SLEEP
#define thc12_SLEEP_API_WAKEUP   __FUTEX_API_WAKEUP
