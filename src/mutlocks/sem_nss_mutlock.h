#ifndef _SEM_NSS_FIN_MUTLOCK_H_
#define _SEM_NSS_FIN_MUTLOCK_H_

#define NAME sem_nss

#define sem_nss_SPIN_API_INIT      __NOFIFO_SPIN_API_INIT
#define sem_nss_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define sem_nss_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define sem_nss_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define sem_nss_SLEEP_API_INIT     __SEM_API_INIT
#define sem_nss_SLEEP_API_DESTROY  __SEM_API_DESTROY
#define sem_nss_SLEEP_API_SLEEP    __SEM_API_SLEEP
#define sem_nss_SLEEP_API_WAKEUP   __SEM_API_WAKEUP
