#ifndef _SEM_NSS2_FIN_MUTLOCK_H_
#define _SEM_NSS2_FIN_MUTLOCK_H_

#define NAME sem_nss2

#define sem_nss2_SPIN_API_INIT      __NOFIFO_SPIN_API_INIT
#define sem_nss2_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define sem_nss2_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define sem_nss2_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define sem_nss2_SLEEP_API_INIT     __SEM_API_INIT
#define sem_nss2_SLEEP_API_DESTROY  __SEM_API_DESTROY
#define sem_nss2_SLEEP_API_SLEEP    __SEM_API_SLEEP
#define sem_nss2_SLEEP_API_WAKEUP   __SEM_API_WAKEUP
