...
#define sem_tcp2_SPIN_API_INIT      __FIFO_SPIN_API_INIT
#define sem_tcp2_SPIN_API_DESTROY   __FIFO_SPIN_API_DESTROY
#define sem_tcp2_SPIN_API_LOCK      __FIFO_SPIN_API_LOCK
#define sem_tcp2_SPIN_API_UNLOCK    __FIFO_SPIN_API_UNLOCK
