#ifndef _NSS_FIN_MUTLOCK_H_
#define _NSS_FIN_MUTLOCK_H_

#define NAME nss

#define nss_SPIN_API_INIT      __NOFIFO_SPIN_API_INIT
#define nss_SPIN_API_DESTROY   __NOFIFO_SPIN_API_DESTROY
#define nss_SPIN_API_LOCK      __NOFIFO_SPIN_API_LOCK
#define nss_SPIN_API_UNLOCK    __NOFIFO_SPIN_API_UNLOCK

#define nss_SLEEP_API_INIT     __FUTEX_API_INIT
#define nss_SLEEP_API_DESTROY  __FUTEX_API_DESTROY
#define nss_SLEEP_API_SLEEP    __FUTEX_API_SLEEP
#define nss_SLEEP_API_WAKEUP   __FUTEX_API_WAKEUP
